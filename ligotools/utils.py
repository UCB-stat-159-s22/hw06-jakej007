## This is the python utils file for the ligotools package
import numpy as np
...
def plot_PSD(
    ...
    """ calculate and plot out data from each PSD of the data """
    ...
    if not make_plots:
        # Return several in-function variables
        return d_eff, phase, offset, template_rolled
